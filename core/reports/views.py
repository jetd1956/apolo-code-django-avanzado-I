    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                ...
                subtotal = queryset.aggregate(r=Sum(Cast('subtotal',output_field=FloatField()))).get('r') or 0
                iva = queryset.aggregate(r=Sum(Cast('iva',output_field=FloatField()))).get('r') or 0
                total = queryset.aggregate(r=Sum(Cast('total',output_field=FloatField()))).get('r') or 0
